...
import gov.nih.nci.cagrid.sdkquery4.processor2.RoleNameResolver.ClassAssociation;
...
public class CQL2ToParameterizedHQL {
    ...
    public CQL2ToParameterizedHQL(DomainTypesInformation typesInfo, DomainModel model) {
    ...
    public ParameterizedHqlQuery convertToHql(CQLQuery query) throws Exception {
        ...
        List<String> subclasses = typesInfoUtil.getSubclasses(query.getCQLTargetObject().getClassName());
        ...
        processTarget(query.getCQLTargetObject(), query.getAssociationPopulationSpecification(), rawHql, parameters,
            hasSubclasses);
    ...
    private void processAttribute(CQLAttribute attribute, StringBuilder hql, List<java.lang.Object> parameters,
        ...
        String attributeFieldType = typesInfoUtil.getAttributeJavaType(
            queryObject.getClassName(), attribute.getName());
        if (attributeFieldType == null) {
            throw new Exception("Field type of " + queryObject.getClassName() + 
