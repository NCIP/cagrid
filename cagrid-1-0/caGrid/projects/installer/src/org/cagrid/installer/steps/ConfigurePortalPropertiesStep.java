...
public class ConfigurePortalPropertiesStep extends PropertyConfigurationStep
	...
	public void init(WizardModel m) {
		...
		String[] idxSvcUrls = this.model
				.getProperty(Constants.PORTAL_INDEX_SVC_URLS,
...
//		this.idxTable.setPreferredScrollableViewportSize(new Dimension(500, 200));
		indexSvcUrlsPanel.add(BorderLayout.NORTH, new JLabel(this.model
				.getMessage("portal.index.svc.urls")));
	...
	public void applyState() throws InvalidStateException {
		...
		this.model.setProperty(Constants.PORTAL_INDEX_SVC_URLS, sb.toString());
	}
