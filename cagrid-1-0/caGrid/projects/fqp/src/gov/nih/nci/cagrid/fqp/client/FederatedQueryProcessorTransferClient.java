...
{ 
    ...
    public static void usage() {
        System.out.println(FederatedQueryProcessorTransferClient.class.getName() + " -url <service url> -dcql <DCQL file>");
    }
        ...
        try {
        	if (!(args.length < 4)) {
                if (args[0].equals("-url")) {
                    ...
                    Utils.serializeDocument("resultEPR.xml", resultsClilent.getEndpointReference(), 
                    		new QName("http://schemas.xmlsoap.org/ws/2004/03/addressing", "EndPointReference"));
		            ...
		            System.out.println();
		            System.out.println("Got results, iterating");
...
//		            }
		            ...
		            if (url.startsWith("https")) {
		            	...
		            	transferClient.destroy(new Destroy());
		            }
		            else {
		            	TransferServiceContextClient transferClient = new TransferServiceContextClient(transferRef.getEndpointReference());
