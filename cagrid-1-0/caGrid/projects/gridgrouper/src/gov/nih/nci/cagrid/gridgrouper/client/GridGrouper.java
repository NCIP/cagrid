...
public class GridGrouper extends GridGrouperObject implements GrouperI {
	...
	public Set<GroupI> getMembersGroups(String subject, MembershipType type)
	...
	public Set<GroupI> getMembersEffectiveGroups(String subject)
			throws GrouperRuntimeException, InsufficientPrivilegeException {
		return getMembersGroups(subject, MembershipType.EffectiveMembers);
	}

	public Set<GroupI> getMembersGroups(String subject)
			throws GrouperRuntimeException, InsufficientPrivilegeException {
		return getMembersGroups(subject, MembershipType.Any);
	}

	public Set<GroupI> getMembersImmediateGroups(String subject)
			throws GrouperRuntimeException, InsufficientPrivilegeException {
