 ...
 * @created Sep 26, 2006
 * @version $Id: SchemaTypesPanel.java,v 1.1.2.2 2007-09-04 18:23:41 dervin Exp $
 */
public class SchemaTypesPanel extends AbstractWizardPanel {
    ...
    private void findSchemas() {
        ...
        try {
            ...
            ex.printStackTrace();
            ErrorDialog.showErrorDialog("Error retrieving schemas GME. GME 1.0 service has been deprecated.", ex);
        }
    }
