 ...
 */
public class GridServiceEndPointCatalogAspectTest extends PortalAggrIntegrationTestBase {
    ...
    public GridServiceEndPointCatalogAspectTest() throws Exception {
        super();
        TestDB.create();
    ...
    public void testAspect() throws Exception {
        ...
        meta.smeta = (gov.nih.nci.cagrid.metadata.MetadataUtils
                ...
                "test/data/caarrayServiceMetadata.xml")));
    ...
    public void setRegisteredServiceListener(RegisteredServiceListener registeredServiceListener) {
