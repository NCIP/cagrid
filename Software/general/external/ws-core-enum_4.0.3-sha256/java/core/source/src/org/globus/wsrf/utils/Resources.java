    ...
    static final Object[][] contents =
        {
            {
                "configError", 
                "property ''{0}'' has an incorrect or invalid value"
            },
            ...
            },
            {
                ...
                "Failed to create resource property document"
            },
            {
            ...
            {"expectedType", "Expected object of type ''{0}'' but got ''{1}''"},
            ...
            {
                "memFault01",
                "Run out of heap (server level)"
            },
            {
                "memFault02",
                "Run out of memory (application level)"
            },
            {
                "serverFault02",
            ...
            {
                "serviceDispatcherAcceptError01",
