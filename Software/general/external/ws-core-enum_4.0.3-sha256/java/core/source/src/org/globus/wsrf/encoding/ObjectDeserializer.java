...
public class ObjectDeserializer {
     ...
     * @param javaClass class containing the meta data about how to deserialize
     *        the element or a simple Java type such as Integer.
     * @return Java object that maps to the XML representation of the input.
     *         Please note that when the javaClass parameter is specified it
     *         is not guaranteed that the deserialized object will be of this
     *         type. The input element can have a <i>xsi:type</i> attribute 
     *         that maps into a different Java type.
     ...
     * Converts an array of SOAPElement objects into a set of Java objects.
     *
     * @param elements an array of elements to convert
     * @param javaClass class containing the meta data about how to deserialize
     *        the elements or a simple Java type such as Integer.
     * @return an array of Java objects (Object[]) that map to the XML 
     *         representation of the input elements. 
     *         Please note that when the javaClass parameter is specified it
     *         is not guaranteed that the deserialized objects will be of this
     *         type or that the objects in the array will be of the same type.
     *         The input elements can have different <i>xsi:type</i>
     *         attribute that could map into different Java types.
     * @throws DeserializationException if deserialization fails.
     */
