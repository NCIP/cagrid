...
public class ConsumerSOAPBindingStub extends org.apache.axis.client.Stub implements org.globus.wsrf.core.notification.Consumer {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("Notify");
        oper.addParameter(new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/2004/06/wsn-WS-BaseNotification-1.2-draft-01.xsd", "Notify"), new javax.xml.namespace.QName("http://docs.oasis-open.org/wsn/2004/06/wsn-WS-BaseNotification-1.2-draft-01.xsd", ">Notify"), org.oasis.wsn.Notify.class, org.apache.axis.description.ParameterDesc.IN, false, false);
    ...
    public ConsumerSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ConsumerSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ConsumerSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
            ...
            qName = new javax.xml.namespace.QName("http://wsrf.globus.org/core/notification", "ResourcePropertyValueChangeNotificationElementType");
            cachedSerQNames.add(qName);
            cls = org.globus.wsrf.core.notification.ResourcePropertyValueChangeNotificationElementType.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public void notify(org.oasis.wsn.Notify notify) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setSOAPActionURI("http://docs.oasis-open.org/wsn/2004/06/wsn-WS-BaseNotification/Notify");
        _call.setEncodingStyle(null);
