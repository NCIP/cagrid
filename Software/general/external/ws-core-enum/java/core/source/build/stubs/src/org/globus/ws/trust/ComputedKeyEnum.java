...
public class ComputedKeyEnum implements java.io.Serializable {
    ...
    static {
    	try {
            _value1 = new org.apache.axis.types.URI("http://schemas.xmlsoap.org/ws/2004/04/security/trust/CK/PSHA1");
        }
    ...
    static {
    	try {
            _value2 = new org.apache.axis.types.URI("http://schemas.xmlsoap.org/ws/2004/04/security/trust/CK/HASH");
        }
        catch (org.apache.axis.types.URI.MalformedURIException mue) {
            throw new java.lang.RuntimeException(mue.toString());
        }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/ws/2004/04/trust", "ComputedKeyEnum"));
    }
    /**
