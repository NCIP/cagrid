...
public class BinarySecretTypeOpenEnum  implements java.io.Serializable, org.apache.axis.encoding.SimpleType {
    ...
    public BinarySecretTypeOpenEnum() {
    }
    ...
    public BinarySecretTypeOpenEnum(org.globus.ws.trust.BinarySecretTypeEnum _value) {
     ...
     */
    public org.globus.ws.trust.BinarySecretTypeEnum getBinarySecretTypeEnumValue() {
        return org.globus.ws.trust.BinarySecretTypeEnum.fromString(_value);
    }
     ...
     * @param _value
     */
    public void setBinarySecretTypeEnumValue(org.globus.ws.trust.BinarySecretTypeEnum _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/ws/2004/04/trust", "BinarySecretTypeOpenEnum"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/ws/2004/04/trust", "BinarySecretTypeEnum"));
