/**
 * PersistenceTestSubscriptionManagerSOAPBindingStub.java
 *
...
public class PersistenceTestSubscriptionManagerSOAPBindingStub extends org.apache.axis.client.Stub implements org.globus.wsrf.core.notification.PersistenceTestSubscriptionManager {
    ...
    public PersistenceTestSubscriptionManagerSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public PersistenceTestSubscriptionManagerSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public PersistenceTestSubscriptionManagerSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
            ...
            qName = new javax.xml.namespace.QName("http://wsrf.globus.org/core/notification", ">PersistenceTestSubscriptionManagerGTWSDLResourceProperties");
            cachedSerQNames.add(qName);
            cls = org.globus.wsrf.core.notification.PersistenceTestSubscriptionManagerGTWSDLResourceProperties.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public org.globus.wsrf.tests.invalidate.InvalidateResponse invalidate(org.globus.wsrf.tests.invalidate.InvalidateRequest request) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://wsrf.globus.org/core/notification/PersistenceTestSubscriptionManager/invalidateRequest");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
