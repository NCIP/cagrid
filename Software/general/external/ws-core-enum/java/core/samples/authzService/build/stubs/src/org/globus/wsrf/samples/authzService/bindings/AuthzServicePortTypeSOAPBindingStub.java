/**
 * AuthzServicePortTypeSOAPBindingStub.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.2RC2 Apr 28, 2006 (12:42:00 EDT) WSDL2Java emitter.
 */

package org.globus.wsrf.samples.authzService.bindings;

public class AuthzServicePortTypeSOAPBindingStub extends org.apache.axis.client.Stub implements org.globus.wsrf.samples.authzService.AuthzServicePortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("addDeclinedMethod");
        oper.addParameter(new javax.xml.namespace.QName("http://wsrf.globus.org/samples/authzService", "addDeclinedMethod"), new javax.xml.namespace.QName("http://wsrf.globus.org/samples/authzService", "valueType"), org.globus.wsrf.samples.authzService.ValueType.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.setReturnType(new javax.xml.namespace.QName("http://wsrf.globus.org/samples/authzService", ">addDeclinedMethodResponse"));
        oper.setReturnClass(org.globus.wsrf.samples.authzService.AddDeclinedMethodResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://wsrf.globus.org/samples/authzService", "addDeclinedMethodResponse"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[0] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("SAMLRequest");
        oper.addParameter(new javax.xml.namespace.QName("urn:oasis:names:tc:SAML:1.0:protocol", "Request"), new javax.xml.namespace.QName("urn:oasis:names:tc:SAML:1.0:protocol", ">Request"), protocol._0._1.SAML.tc.names.oasis.Request.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.setReturnType(new javax.xml.namespace.QName("urn:oasis:names:tc:SAML:1.0:protocol", ">Response"));
        oper.setReturnClass(protocol._0._1.SAML.tc.names.oasis.Response.class);
        oper.setReturnQName(new javax.xml.namespace.QName("urn:oasis:names:tc:SAML:1.0:protocol", "Response"));
        oper.setStyle(org.apache.axis.constants.Style.DOCUMENT);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[1] = oper;
    ...
    public AuthzServicePortTypeSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public AuthzServicePortTypeSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public AuthzServicePortTypeSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
            ...
            qName = new javax.xml.namespace.QName("http://wsrf.globus.org/samples/authzService", "valueType");
            cachedSerQNames.add(qName);
            cls = org.globus.wsrf.samples.authzService.ValueType.class;
            ...
            qName = new javax.xml.namespace.QName("http://wsrf.globus.org/samples/authzService", ">addDeclinedMethodResponse");
            cachedSerQNames.add(qName);
            cls = org.globus.wsrf.samples.authzService.AddDeclinedMethodResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://wsrf.globus.org/samples/authzService", ">AuthzServicePortTypeGTWSDLResourceProperties");
            cachedSerQNames.add(qName);
            cls = org.globus.wsrf.samples.authzService.AuthzServicePortTypeGTWSDLResourceProperties.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("urn:oasis:names:tc:SAML:1.0:protocol", ">Request");
            cachedSerQNames.add(qName);
            cls = protocol._0._1.SAML.tc.names.oasis.Request.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://www.gridforum.org/namespaces/2004/03/ogsa-authz/saml", ">SAMLPortRP");
            cachedSerQNames.add(qName);
            cls = org.globus.wsrf.security.authorization.SAMLPortRP.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("urn:oasis:names:tc:SAML:1.0:protocol", ">Response");
            cachedSerQNames.add(qName);
            cls = protocol._0._1.SAML.tc.names.oasis.Response.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public org.globus.wsrf.samples.authzService.AddDeclinedMethodResponse addDeclinedMethod(org.globus.wsrf.samples.authzService.ValueType parameters) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("http://wsrf.globus.org/samples/authzService/AuthzServicePortType/addDeclinedMethodRequest");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "addDeclinedMethod"));
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (org.globus.wsrf.samples.authzService.AddDeclinedMethodResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (org.globus.wsrf.samples.authzService.AddDeclinedMethodResponse) org.apache.axis.utils.JavaUtils.convert(_resp, org.globus.wsrf.samples.authzService.AddDeclinedMethodResponse.class);
            }
        }
    }
    ...
    public protocol._0._1.SAML.tc.names.oasis.Response SAMLRequest(protocol._0._1.SAML.tc.names.oasis.Request parameters) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://wsrf.globus.org/samples/authzService/AuthzServicePortType/SAMLRequestRequest");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "SAMLRequest"));
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (protocol._0._1.SAML.tc.names.oasis.Response) _resp;
            } catch (java.lang.Exception _exception) {
                return (protocol._0._1.SAML.tc.names.oasis.Response) org.apache.axis.utils.JavaUtils.convert(_resp, protocol._0._1.SAML.tc.names.oasis.Response.class);
            }
        }
    }
    ...
    public org.oasis.wsrf.properties.GetResourcePropertyResponse getResourceProperty(javax.xml.namespace.QName getResourcePropertyRequest) throws java.rmi.RemoteException, org.oasis.wsrf.properties.InvalidResourcePropertyQNameFaultType, org.oasis.wsrf.properties.ResourceUnknownFaultType {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://wsrf.globus.org/samples/authzService/AuthzServicePortType/GetResourcePropertyRequest");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
    ...
    public org.oasis.wsrf.properties.SetResourcePropertiesResponse setResourceProperties(org.oasis.wsrf.properties.SetResourceProperties_Element setResourcePropertiesRequest) throws java.rmi.RemoteException, org.oasis.wsrf.properties.InvalidResourcePropertyQNameFaultType, org.oasis.wsrf.properties.UnableToModifyResourcePropertyFaultType, org.oasis.wsrf.properties.ResourceUnknownFaultType, org.oasis.wsrf.properties.SetResourcePropertyRequestFailedFaultType, org.oasis.wsrf.properties.InvalidSetResourcePropertiesRequestContentFaultType {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://wsrf.globus.org/samples/authzService/AuthzServicePortType/SetResourcePropertiesRequest");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
    ...
    public org.oasis.wsrf.properties.QueryResourcePropertiesResponse queryResourceProperties(org.oasis.wsrf.properties.QueryResourceProperties_Element queryResourcePropertiesRequest) throws java.rmi.RemoteException, org.oasis.wsrf.properties.InvalidResourcePropertyQNameFaultType, org.oasis.wsrf.properties.InvalidQueryExpressionFaultType, org.oasis.wsrf.properties.QueryEvaluationErrorFaultType, org.oasis.wsrf.properties.ResourceUnknownFaultType, org.oasis.wsrf.properties.UnknownQueryExpressionDialectFaultType {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://wsrf.globus.org/samples/authzService/AuthzServicePortType/QueryResourcePropertiesRequest");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
