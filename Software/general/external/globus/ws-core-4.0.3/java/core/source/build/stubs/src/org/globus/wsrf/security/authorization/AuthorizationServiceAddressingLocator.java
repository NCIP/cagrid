...
public class AuthorizationServiceAddressingLocator extends org.globus.wsrf.security.authorization.AuthorizationServiceLocator implements org.globus.wsrf.security.authorization.AuthorizationServiceAddressing {
    public org.globus.wsrf.security.authorization.SAMLRequestPortType getSAMLRequestPortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	org.globus.wsrf.security.authorization.SAMLRequestPortType _stub = getSAMLRequestPortTypePort(endpoint);
	if (_stub != null) {
