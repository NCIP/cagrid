/**
 * WSResourcePropertiesServiceAddressingLocator.java
 *
...
public class WSResourcePropertiesServiceAddressingLocator extends org.oasis.wsrf.properties.WSResourcePropertiesServiceLocator implements org.oasis.wsrf.properties.WSResourcePropertiesServiceAddressing {
	...
	org.oasis.wsrf.properties.GetResourceProperty _stub = getGetResourcePropertyPort(endpoint);
	if (_stub != null) {
	...
	org.oasis.wsrf.properties.SetResourceProperties_PortType _stub = getSetResourcePropertiesPort(endpoint);
	if (_stub != null) {
		org.apache.axis.message.addressing.AddressingHeaders headers =
			new org.apache.axis.message.addressing.AddressingHeaders();
		headers.setTo(address);
	...
	org.oasis.wsrf.properties.GetMultipleResourceProperties_PortType _stub = getGetMultipleResourcePropertiesPort(endpoint);
	if (_stub != null) {
		org.apache.axis.message.addressing.AddressingHeaders headers =
			new org.apache.axis.message.addressing.AddressingHeaders();
		headers.setTo(address);
	...
	org.oasis.wsrf.properties.QueryResourceProperties_PortType _stub = getQueryResourcePropertiesPort(endpoint);
	if (_stub != null) {
		org.apache.axis.message.addressing.AddressingHeaders headers =
			new org.apache.axis.message.addressing.AddressingHeaders();
		headers.setTo(address);
