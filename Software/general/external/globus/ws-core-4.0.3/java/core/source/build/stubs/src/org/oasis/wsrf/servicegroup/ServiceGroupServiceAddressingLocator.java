/**
 * ServiceGroupServiceAddressingLocator.java
 *
...
public class ServiceGroupServiceAddressingLocator extends org.oasis.wsrf.servicegroup.ServiceGroupServiceLocator implements org.oasis.wsrf.servicegroup.ServiceGroupServiceAddressing {
	...
	org.oasis.wsrf.servicegroup.ServiceGroup _stub = getServiceGroupPort(endpoint);
	if (_stub != null) {
	...
	org.oasis.wsrf.servicegroup.ServiceGroupRegistration _stub = getServiceGroupRegistrationPort(endpoint);
	if (_stub != null) {
		org.apache.axis.message.addressing.AddressingHeaders headers =
			new org.apache.axis.message.addressing.AddressingHeaders();
		headers.setTo(address);
	...
	org.oasis.wsrf.servicegroup.ServiceGroupEntry _stub = getServiceGroupEntryPort(endpoint);
	if (_stub != null) {
		org.apache.axis.message.addressing.AddressingHeaders headers =
			new org.apache.axis.message.addressing.AddressingHeaders();
		headers.setTo(address);
