...
public class KeyTypeEnum implements java.io.Serializable {
    ...
    static {
    	try {
            _value1 = new org.apache.axis.types.URI("http://schemas.xmlsoap.org/ws/2004/04/security/trust/PublicKey");
        }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/ws/2004/04/trust", "KeyTypeEnum"));
    }
    /**
