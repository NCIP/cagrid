/**
 * NotificationConsumerServiceAddressingLocator.java
 *
...
public class NotificationConsumerServiceAddressingLocator extends org.globus.wsrf.core.notification.service.NotificationConsumerServiceLocator implements org.globus.wsrf.core.notification.service.NotificationConsumerServiceAddressing {
    public org.globus.wsrf.core.notification.Consumer getConsumerPort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	org.globus.wsrf.core.notification.Consumer _stub = getConsumerPort(endpoint);
	if (_stub != null) {
