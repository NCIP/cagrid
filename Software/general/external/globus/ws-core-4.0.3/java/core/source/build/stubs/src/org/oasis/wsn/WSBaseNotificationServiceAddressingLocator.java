/**
 * WSBaseNotificationServiceAddressingLocator.java
 *
...
public class WSBaseNotificationServiceAddressingLocator extends org.oasis.wsn.WSBaseNotificationServiceLocator implements org.oasis.wsn.WSBaseNotificationServiceAddressing {
	...
	org.oasis.wsn.NotificationProducer _stub = getNotificationProducerPort(endpoint);
	if (_stub != null) {
	...
	org.oasis.wsn.SubscriptionManager _stub = getSubscriptionManagerPort(endpoint);
	if (_stub != null) {
		org.apache.axis.message.addressing.AddressingHeaders headers =
			new org.apache.axis.message.addressing.AddressingHeaders();
		headers.setTo(address);
	...
	org.oasis.wsn.NotificationConsumer _stub = getNotificationConsumerPort(endpoint);
	if (_stub != null) {
		org.apache.axis.message.addressing.AddressingHeaders headers =
			new org.apache.axis.message.addressing.AddressingHeaders();
		headers.setTo(address);
