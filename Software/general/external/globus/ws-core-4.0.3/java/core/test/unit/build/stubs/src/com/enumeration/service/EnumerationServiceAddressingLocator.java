/**
 * EnumerationServiceAddressingLocator.java
 *
...
public class EnumerationServiceAddressingLocator extends com.enumeration.service.EnumerationServiceLocator implements com.enumeration.service.EnumerationServiceAddressing {
    public com.enumeration.EnumerationPortType getEnumerationPortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	com.enumeration.EnumerationPortType _stub = getEnumerationPortTypePort(endpoint);
	if (_stub != null) {
