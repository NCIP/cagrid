/**
 * TestServiceAddressingLocator.java
 *
...
public class TestServiceAddressingLocator extends org.globus.wsrf.tests.basic.service.TestServiceLocator implements org.globus.wsrf.tests.basic.service.TestServiceAddressing {
    public org.globus.wsrf.tests.basic.TestPortType getTestPortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	org.globus.wsrf.tests.basic.TestPortType _stub = getTestPortTypePort(endpoint);
	if (_stub != null) {
