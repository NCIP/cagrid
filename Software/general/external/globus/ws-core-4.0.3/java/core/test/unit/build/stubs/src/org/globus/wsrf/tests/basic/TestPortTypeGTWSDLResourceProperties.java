/**
 * TestPortTypeGTWSDLResourceProperties.java
 *
...
public class TestPortTypeGTWSDLResourceProperties  implements java.io.Serializable {
    private java.util.Calendar currentTime;
    private java.util.Calendar terminationTime;

    public TestPortTypeGTWSDLResourceProperties() {
    }
    ...
    /**
     * Gets the currentTime value for this TestPortTypeGTWSDLResourceProperties.
     * 
     * @return currentTime
     */
    ...
    /**
     * Sets the currentTime value for this TestPortTypeGTWSDLResourceProperties.
     * 
     * @param currentTime
     */
    ...
    /**
     * Gets the terminationTime value for this TestPortTypeGTWSDLResourceProperties.
     * 
    ...
    /**
     * Sets the terminationTime value for this TestPortTypeGTWSDLResourceProperties.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TestPortTypeGTWSDLResourceProperties)) return false;
        TestPortTypeGTWSDLResourceProperties other = (TestPortTypeGTWSDLResourceProperties) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TestPortTypeGTWSDLResourceProperties.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://wsrf.globus.org/tests/basic", ">TestPortTypeGTWSDLResourceProperties"));
