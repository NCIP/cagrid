/**
 * AuthzServicePortTypeGTWSDLResourceProperties.java
 *
...
public class AuthzServicePortTypeGTWSDLResourceProperties  implements java.io.Serializable {
    private boolean supportsIndeterminate;
    private boolean signatureCapable;
    private org.apache.axis.types.URI[] supportedPolicies;

    public AuthzServicePortTypeGTWSDLResourceProperties() {
    }
    ...
    /**
     * Gets the supportsIndeterminate value for this AuthzServicePortTypeGTWSDLResourceProperties.
     * 
    ...
    /**
     * Sets the supportsIndeterminate value for this AuthzServicePortTypeGTWSDLResourceProperties.
     * 
    ...
    /**
     * Gets the signatureCapable value for this AuthzServicePortTypeGTWSDLResourceProperties.
     * 
    ...
    /**
     * Sets the signatureCapable value for this AuthzServicePortTypeGTWSDLResourceProperties.
     * 
    ...
    /**
     * Gets the supportedPolicies value for this AuthzServicePortTypeGTWSDLResourceProperties.
     * 
    ...
    /**
     * Sets the supportedPolicies value for this AuthzServicePortTypeGTWSDLResourceProperties.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AuthzServicePortTypeGTWSDLResourceProperties)) return false;
        AuthzServicePortTypeGTWSDLResourceProperties other = (AuthzServicePortTypeGTWSDLResourceProperties) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AuthzServicePortTypeGTWSDLResourceProperties.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://wsrf.globus.org/samples/authzService", ">AuthzServicePortTypeGTWSDLResourceProperties"));
