/**
 * CounterServiceAddressingLocator.java
 *
...
public class CounterServiceAddressingLocator extends com.counter.service.CounterServiceLocator implements com.counter.service.CounterServiceAddressing {
    public com.counter.CounterPortType getCounterPortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	com.counter.CounterPortType _stub = getCounterPortTypePort(endpoint);
	if (_stub != null) {
