/**
 * ManagementServiceAddressingLocator.java
 *
...
public class ManagementServiceAddressingLocator extends com.management.service.ManagementServiceLocator implements com.management.service.ManagementServiceAddressing {
    public com.management.ManagementPort getManagementPortPort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	com.management.ManagementPort _stub = getManagementPortPort(endpoint);
	if (_stub != null) {
