/**
 * RegistryServiceAddressingLocator.java
 *
...
public class RegistryServiceAddressingLocator extends org.globus.core.registry.RegistryServiceLocator implements org.globus.core.registry.RegistryServiceAddressing {
    public org.globus.core.registry.RegistryPortType getRegistryPortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	org.globus.core.registry.RegistryPortType _stub = getRegistryPortTypePort(endpoint);
	if (_stub != null) {
