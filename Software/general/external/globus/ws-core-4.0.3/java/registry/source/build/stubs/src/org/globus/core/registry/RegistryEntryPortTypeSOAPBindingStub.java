/**
 * RegistryEntryPortTypeSOAPBindingStub.java
 *
...
public class RegistryEntryPortTypeSOAPBindingStub extends org.apache.axis.client.Stub implements org.globus.core.registry.RegistryEntryPortType {
    ...
    public RegistryEntryPortTypeSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public RegistryEntryPortTypeSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public RegistryEntryPortTypeSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
            ...
            qName = new javax.xml.namespace.QName("http://www.globus.org/namespaces/2004/06/registry", ">RegistryEntryPortTypeGTWSDLResourceProperties");
            cachedSerQNames.add(qName);
            cls = org.globus.core.registry.RegistryEntryPortTypeGTWSDLResourceProperties.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
