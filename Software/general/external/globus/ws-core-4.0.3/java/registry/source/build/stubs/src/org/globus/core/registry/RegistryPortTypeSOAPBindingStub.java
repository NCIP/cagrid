/**
 * RegistryPortTypeSOAPBindingStub.java
 *
...
public class RegistryPortTypeSOAPBindingStub extends org.apache.axis.client.Stub implements org.globus.core.registry.RegistryPortType {
    ...
    public RegistryPortTypeSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public RegistryPortTypeSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public RegistryPortTypeSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
            ...
            qName = new javax.xml.namespace.QName("http://www.globus.org/namespaces/2004/06/registry", ">RegistryPortTypeGTWSDLResourceProperties");
            cachedSerQNames.add(qName);
            cls = org.globus.core.registry.RegistryPortTypeGTWSDLResourceProperties.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
