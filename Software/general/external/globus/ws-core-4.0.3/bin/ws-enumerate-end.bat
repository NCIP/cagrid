...
%_RUNJAVA%  %LOCAL_OPTS% %GLOBUS_OPTIONS% -classpath %LOCALCLASSPATH% org.globus.bootstrap.Bootstrap org.globus.ws.enumeration.client.EndEnumerate %CMD_LINE_ARGS%
