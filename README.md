Welcome to the caGrid Project!
=====================================
*NOTE* the entire caGrid repository was migrated to capture the total release history, including all branches.
Please do not checkout and use this repository, instead use the relevant cagrid-* github project.  
...
caGrid is an Open Source project written in Java, and makes use of:
...
caGrid is distributed under the BSD 3-Clause License.
Please see the NOTICE and LICENSE files for details.

You will find more details about caGrid in the following links:
